...
def main(args):
    ...
    # otherwisae, get directory from input files
        ...
        tmpdir = os.path.dirname(os.path.realpath(args.pepfile))+"/tmp"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o',  '--p2afile',  required=True, help='Output file with the peptides2all')  
    ...
    # add filehandler
    logfile = os.path.dirname(os.path.realpath(args.pepfile)) + "/"+ scriptname +".log"
    if args.logfile:
