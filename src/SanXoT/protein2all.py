...
def main(args):
    ...
    # otherwisae, get directory from input files
        ...
        tmpdir = os.path.dirname(os.path.realpath(args.profile))+"/tmp"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o',  '--q2afile',  required=True, help='Output file with the protein2all')
    ...
    # add filehandler
    logfile = os.path.dirname(os.path.realpath(args.profile)) + "/"+ scriptname +".log"
    if args.logfile:
